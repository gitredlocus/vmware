package QLogicFCHBA_ComputerSystemSCSIProtocolEndpointHBA;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::CIM_HostedAccessPoint;
use strict;


@QLogicFCHBA_ComputerSystemSCSIProtocolEndpointHBA::ISA = qw(_Initializable CIM_HostedAccessPoint);
