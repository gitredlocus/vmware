package VMware_ElementConformsToExtensionServiceProfile;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::CIM_ElementConformsToProfile;
use strict;


@VMware_ElementConformsToExtensionServiceProfile::ISA = qw(_Initializable CIM_ElementConformsToProfile);
