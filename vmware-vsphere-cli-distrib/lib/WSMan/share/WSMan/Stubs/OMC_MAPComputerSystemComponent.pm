package OMC_MAPComputerSystemComponent;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::CIM_SystemComponent;
use strict;


@OMC_MAPComputerSystemComponent::ISA = qw(_Initializable CIM_SystemComponent);
...
sub _init{
    my ($self, %args) = @_;
    $self->CIM_SystemComponent::_init();
