package OMC_RegisteredProfileInNamespace;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::CIM_ConcreteDependency;
use strict;


@OMC_RegisteredProfileInNamespace::ISA = qw(_Initializable CIM_ConcreteDependency);
...
sub _init{
    my ($self, %args) = @_;
    $self->CIM_ConcreteDependency::_init();
