package OMC_IPAssignmentSettingDataOrderedComponent;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::CIM_OrderedComponent;
use strict;


@OMC_IPAssignmentSettingDataOrderedComponent::ISA = qw(_Initializable CIM_OrderedComponent);
...
sub _init{
    my ($self, %args) = @_;
    $self->CIM_OrderedComponent::_init();
