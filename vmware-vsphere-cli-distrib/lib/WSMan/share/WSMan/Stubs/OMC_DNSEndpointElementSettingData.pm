package OMC_DNSEndpointElementSettingData;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::OMC_DNSElementSettingData;
use strict;


@OMC_DNSEndpointElementSettingData::ISA = qw(_Initializable OMC_DNSElementSettingData);
...
sub _init{
    my ($self, %args) = @_;
    $self->OMC_DNSElementSettingData::_init();
