package ELXHBA_SCSIArbitraryLogicalUnit;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::CIM_SCSIArbitraryLogicalUnit;
use strict;


@ELXHBA_SCSIArbitraryLogicalUnit::ISA = qw(_Initializable CIM_SCSIArbitraryLogicalUnit);
...
sub _init{
    my ($self, %args) = @_;
    $self->CIM_SCSIArbitraryLogicalUnit::_init();
