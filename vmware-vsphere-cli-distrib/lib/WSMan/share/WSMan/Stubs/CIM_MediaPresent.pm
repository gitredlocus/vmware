package CIM_MediaPresent;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::CIM_Dependency;
use strict;


@CIM_MediaPresent::ISA = qw(_Initializable CIM_Dependency);
...
#===============================================================================
#            FixedMedia accessor method.
#===============================================================================

sub FixedMedia{
    my ($self, $newval) = @_;
    $self->{FixedMedia} = $newval if @_ > 1;
    return $self->{FixedMedia};
}
#===============================================================================
