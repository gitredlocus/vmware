package OMC_ElementConformsToProfileRegistrationProfile;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::OMC_ElementConformsToProfile;
use strict;


@OMC_ElementConformsToProfileRegistrationProfile::ISA = qw(_Initializable OMC_ElementConformsToProfile);
