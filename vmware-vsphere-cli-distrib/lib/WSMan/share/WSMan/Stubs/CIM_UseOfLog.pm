package CIM_UseOfLog;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::CIM_Dependency;
use strict;


@CIM_UseOfLog::ISA = qw(_Initializable CIM_Dependency);
...
#===============================================================================
#            RecordedData accessor method.
#===============================================================================

sub RecordedData{
    my ($self, $newval) = @_;
    $self->{RecordedData} = $newval if @_ > 1;
