package CIM_MemoryOnCard;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::CIM_PackagedComponent;
use strict;


@CIM_MemoryOnCard::ISA = qw(_Initializable CIM_PackagedComponent);
...
sub _init{
    my ($self, %args) = @_;
    $self->CIM_PackagedComponent::_init();
