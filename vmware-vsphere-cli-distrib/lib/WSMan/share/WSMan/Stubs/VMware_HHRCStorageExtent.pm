package VMware_HHRCStorageExtent;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::vmware_storageextent;
use strict;


@VMware_HHRCStorageExtent::ISA = qw(_Initializable VMware_StorageExtent);
...
sub _init{
    my ($self, %args) = @_;
    $self->VMware_StorageExtent::_init();
