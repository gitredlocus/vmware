package VMware_VMwareHypervisorStorageExtentIdentityAssociation;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::CIM_LogicalIdentity;
use strict;


@VMware_VMwareHypervisorStorageExtentIdentityAssociation::ISA = qw(_Initializable CIM_LogicalIdentity);
