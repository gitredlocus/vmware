package QLogicFCHBA_RegisteredProfileRegisteredSubProfile;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::CIM_SubProfileRequiresProfile;
use strict;


@QLogicFCHBA_RegisteredProfileRegisteredSubProfile::ISA = qw(_Initializable CIM_SubProfileRequiresProfile);
