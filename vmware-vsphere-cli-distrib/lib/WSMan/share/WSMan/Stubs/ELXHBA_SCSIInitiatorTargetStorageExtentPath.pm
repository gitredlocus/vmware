package ELXHBA_SCSIInitiatorTargetStorageExtentPath;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::CIM_SCSIInitiatorTargetLogicalUnitPath;
use strict;


@ELXHBA_SCSIInitiatorTargetStorageExtentPath::ISA = qw(_Initializable CIM_SCSIInitiatorTargetLogicalUnitPath);
