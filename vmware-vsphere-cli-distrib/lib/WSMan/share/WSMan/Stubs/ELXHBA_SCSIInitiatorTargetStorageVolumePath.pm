package ELXHBA_SCSIInitiatorTargetStorageVolumePath;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::CIM_SCSIInitiatorTargetLogicalUnitPath;
use strict;


@ELXHBA_SCSIInitiatorTargetStorageVolumePath::ISA = qw(_Initializable CIM_SCSIInitiatorTargetLogicalUnitPath);
