package CIM_RemoteAccessAvailableToElement;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::CIM_Dependency;
use strict;


@CIM_RemoteAccessAvailableToElement::ISA = qw(_Initializable CIM_Dependency);
...
#===============================================================================
#            OrderOfAccess accessor method.
#===============================================================================

sub OrderOfAccess{
    my ($self, $newval) = @_;
    $self->{OrderOfAccess} = $newval if @_ > 1;
    return $self->{OrderOfAccess};
}
#===============================================================================
