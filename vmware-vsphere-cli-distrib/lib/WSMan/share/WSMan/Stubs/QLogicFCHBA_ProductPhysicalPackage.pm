package QLogicFCHBA_ProductPhysicalPackage;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::CIM_ProductPhysicalComponent;
use strict;


@QLogicFCHBA_ProductPhysicalPackage::ISA = qw(_Initializable CIM_ProductPhysicalComponent);
...
sub _init{
    my ($self, %args) = @_;
    $self->CIM_ProductPhysicalComponent::_init();
