package CIM_HostedStoragePool;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::CIM_HostedResourcePool;
use strict;


@CIM_HostedStoragePool::ISA = qw(_Initializable CIM_HostedResourcePool);
...
sub _init{
    my ($self, %args) = @_;
    $self->CIM_HostedResourcePool::_init();
