package LSIESG_TargetATAProtocolEndpoint;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::CIM_ATAProtocolEndpoint;
use strict;


@LSIESG_TargetATAProtocolEndpoint::ISA = qw(_Initializable CIM_ATAProtocolEndpoint);
...
sub _init{
    my ($self, %args) = @_;
    $self->CIM_ATAProtocolEndpoint::_init();
