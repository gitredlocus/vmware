package VMware_PowerManagementServiceElementConformsToProfile;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::CIM_ElementConformsToProfile;
use strict;


@VMware_PowerManagementServiceElementConformsToProfile::ISA = qw(_Initializable CIM_ElementConformsToProfile);
