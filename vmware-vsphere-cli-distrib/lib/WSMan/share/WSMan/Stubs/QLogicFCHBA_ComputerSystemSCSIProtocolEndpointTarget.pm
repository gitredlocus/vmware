package QLogicFCHBA_ComputerSystemSCSIProtocolEndpointTarget;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::CIM_HostedAccessPoint;
use strict;


@QLogicFCHBA_ComputerSystemSCSIProtocolEndpointTarget::ISA = qw(_Initializable CIM_HostedAccessPoint);
