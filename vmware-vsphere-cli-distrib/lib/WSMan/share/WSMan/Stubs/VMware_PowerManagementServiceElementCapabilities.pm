package VMware_PowerManagementServiceElementCapabilities;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::CIM_ElementCapabilities;
use strict;


@VMware_PowerManagementServiceElementCapabilities::ISA = qw(_Initializable CIM_ElementCapabilities);
