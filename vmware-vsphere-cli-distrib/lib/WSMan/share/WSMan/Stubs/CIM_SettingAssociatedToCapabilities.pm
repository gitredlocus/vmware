package CIM_SettingAssociatedToCapabilities;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::CIM_Dependency;
use strict;


@CIM_SettingAssociatedToCapabilities::ISA = qw(_Initializable CIM_Dependency);
...
#===============================================================================
#            DefaultSetting accessor method.
#===============================================================================

sub DefaultSetting{
    my ($self, $newval) = @_;
    $self->{DefaultSetting} = $newval if @_ > 1;
