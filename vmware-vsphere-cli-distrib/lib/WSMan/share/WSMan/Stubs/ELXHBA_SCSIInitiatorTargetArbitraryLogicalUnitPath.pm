package ELXHBA_SCSIInitiatorTargetArbitraryLogicalUnitPath;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::CIM_SCSIInitiatorTargetLogicalUnitPath;
use strict;


@ELXHBA_SCSIInitiatorTargetArbitraryLogicalUnitPath::ISA = qw(_Initializable CIM_SCSIInitiatorTargetLogicalUnitPath);
