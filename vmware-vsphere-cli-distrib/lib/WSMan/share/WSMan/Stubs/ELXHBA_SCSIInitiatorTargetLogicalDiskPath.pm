package ELXHBA_SCSIInitiatorTargetLogicalDiskPath;
use WSMan::Stubs::Initializable;
use WSMan::Stubs::CIM_SCSIInitiatorTargetLogicalUnitPath;
use strict;


@ELXHBA_SCSIInitiatorTargetLogicalDiskPath::ISA = qw(_Initializable CIM_SCSIInitiatorTargetLogicalUnitPath);
